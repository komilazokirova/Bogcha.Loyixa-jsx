...
export default function MainLayout() {
    ...
    return (
        <div className="flex h-screen bg-cream">
            {/* Mobil uchun qora overlay - Sidebar ochiq bo'lganda ko'rinadi */}
            {sidebarOpen && (
                <div
            ...
            {/* Sidebar */}
            <aside
                className={`fixed lg:static inset-y-0 left-0 z-50 w-64 flex flex-col bg-white border-r border-gray-100 transform transition-transform duration-200 ${sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
                    }`}
            >
                <div className="h-20 px-6 flex items-center justify-between gap-2.5 border-b border-gray-100">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto p-4 sm:p-6 bg-cream">
                    <Outlet />
                </main>
            </div>
        </div>
